...
export const metadata: Metadata = {
  title: "TapIn - One URL for all your links",
  ...
  metadataBase: new URL("https://tapin-lake.vercel.app"),
  openGraph: {
    title: "TapIn - One URL for all your links",
    description: "Create a beautiful profile page to share all your important links in one place. Open source alternative to Linktree.",
    url: "https://tapin-lake.vercel.app",
    siteName: "TapIn",
    images: [
      {
        url: "/og.png",
        width: 1200,
        height: 630,
        alt: "TapIn - One URL for all your links",
      },
    ],
    locale: "en_US",
    type: "website",
